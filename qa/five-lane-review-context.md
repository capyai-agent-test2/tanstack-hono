...
This PR intentionally introduces several contract files in a baseline commit. A later commit mutates those same-PR contracts while also mutating endpoints that already existed on master.
